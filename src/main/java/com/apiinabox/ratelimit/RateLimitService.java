...
/**
 * Simple rate limiting service using Resilience4j. Handles three use cases: 1. Per-API endpoint
 * limits 2. Per-IP address limits across all APIs 3. Per-client ID limits across all APIs
 */
@Service
public class RateLimitService {
  ...
  private void logRateLimitRejection(
      String limitType, String apiPath, String ipAddress, String clientId, String reason) {
    logger.warn(
        "Rate limit rejection - Type: {}, API: {}, IP: {}, Client: {}, Reason: {}",
        limitType,
